...
class ActiveSessionTab extends StatefulWidget {
  @override
  _ActiveSessionTabState createState() => _ActiveSessionTabState();
}

class _ActiveSessionTabState extends State<ActiveSessionTab> {
  var _isInit = true;
  ...
  void didChangeDependencies() {
    if (_isInit) {
      Provider.of<CyclingSessionProvider>(context, listen: true)
          .getCyclingActiveSessionByUser(true);
    }
    _isInit = false;
